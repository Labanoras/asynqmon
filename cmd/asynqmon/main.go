...
func parseFlags(progname string, args []string) (cfg *Config, output string, err error) {
	...
	flags.StringVar(&conf.BasicAuth, "basic-auth", getEnvDefaultString("BASIC_AUTH", ""), "enable HTTP basic authentication while username and password is provided (<USERNAME>:<PASSWORD>)")
